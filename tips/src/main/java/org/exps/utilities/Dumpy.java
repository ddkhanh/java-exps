...
public class Dumpy {
    ...
    public static Process spawnProcess(String ...args) throws IOException, InterruptedException {
        return spawnProcess(true, args);
    }

    public static Process spawnProcess(boolean wait, String ...args) throws InterruptedException, IOException {
